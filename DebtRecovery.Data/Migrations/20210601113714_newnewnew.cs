        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotPayed = table.Column<double>(nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Address", "Contact", "Email", "FK_Agent", "FK_Scenario", "FaxNumber", "LatePayment", "LegalIdentifier", "Litigation", "Name", "NotPayed", "PhoneNumber", "Profile" },
                values: new object[] { new Guid("a2730fa7-d7e0-40f0-bb5f-75092d8c5583"), null, "Sfaxi Arij", "Mg@tunis.com.tn", new Guid("fb2b536c-b4cb-485e-b65f-30679cf0410b"), new Guid("9bebb407-74df-4f82-96c8-bb523a99b3e3"), "70861236", 0.0, "MLK025F001", false, "Magazin Generale", 0.0, "71256587", null });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Address", "Contact", "Email", "FK_Agent", "FK_Scenario", "FaxNumber", "LatePayment", "LegalIdentifier", "Litigation", "Name", "NotPayed", "PhoneNumber", "Profile" },
                values: new object[] { new Guid("17f50cf3-3baa-490e-8716-06c4921f9afe"), null, "Ouni Ramzi", "thabet25@gmail.com", new Guid("fb2b536c-b4cb-485e-b65f-30679cf0410b"), new Guid("9bebb407-74df-4f82-96c8-bb523a99b3e3"), "70256354", 0.0, "RCK023MJ556", false, "PV Mazraa sidi Thabet", 0.0, "23256587", null });
